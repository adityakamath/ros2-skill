...
| [`references/AGENT-OPERATIONS.md`](references/AGENT-OPERATIONS.md) | Load for the full agent operating protocol — condensed rules, session start detail, reporting style, subcommand inference, motion workflows, and multi-robot handling. Load alongside the RULES-*.md files at session start. |
